...
call %POIROT_ROOT%\Poirot4.NET\BCT\BytecodeTranslator.exe /e:1 /ib /whole /heap:splitFields %file_name%.exe bin\Debug\Server_A.dll bin\Debug\Server_B.dll bin\Debug\Server_C.dll bin\Debug\Message.dll bin\Debug\CST.dll
