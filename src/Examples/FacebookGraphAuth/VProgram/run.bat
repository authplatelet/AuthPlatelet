...
call %POIROT_ROOT%\Poirot4.NET\BCT\BytecodeTranslator.exe /e:1 /ib /whole /heap:splitFields %file_name%.exe bin\Debug\OAuth20NameSpace.dll bin\Debug\GenericAuthNameSpace.dll bin\Debug\Facebook_AP.dll bin\Debug\FacebookGraphApiExample.dll bin\Debug\CST.dll
