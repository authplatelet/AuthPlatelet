...
implementation PoirotMain.Main()
{
  ...
  anon0:
    ...
    call T$OAuth20NameSpace.For_vProgram.#cctor();
    call T$OAuth20NameSpace.AuthorizationServer.#cctor();
    call T$OAuth20NameSpace.Properties.Resources.#cctor();
    ...
    call T$OAuth20NameSpace.AuthorizationServerImpl.AccessTokenDictionary_def.#cctor();
    call T$OAuth20NameSpace.AuthorizationServerImpl.#cctor();
    call FacebookGraphApiExample.Facebook_GraphAuth.#cctor();
    call T$FacebookGraphApiExample.Facebook_GraphAuth.JsonDataStrcuture.#cctor();
    call OAuth20NameSpace.ResourceServerImpl.#cctor();
    call T$OAuth20NameSpace.ResourceServerImpl.ResourceRecs_def.#cctor();
    call T$OAuth20NameSpace.ResourceServerImpl.EmailResource.#cctor();
    call T$OAuth20NameSpace.ResourceServerImpl.EmailPermission.#cctor();
    call T$OAuth20NameSpace.ResourceServerImpl.FBPermssionJSon.#cctor();
    call T$OAuth20NameSpace.ResourceServerImpl.FBPermssionData.#cctor();
...
implementation OAuth20NameSpace.AuthorizationServer.ValidateTicket$OAuth20NameSpace.ValidateTokenRequest($this: Ref, req$in: Ref) returns ($result: Ref)
{
  ...
  anon60_Then:
    assume {:partition} $TypeConstructor($DynamicType($tmp12)) == T$OAuth20NameSpace.AuthorizationServerImpl.AccessTokenDictionary_def;
...
implementation OAuth20NameSpace.AuthorizationServer.SignInIdP$GenericAuthNameSpace.SignInIdP_Req($this: Ref, req$in: Ref) returns ($result: Ref)
{
  ...
  anon47_Then:
    assume {:partition} $TypeConstructor($DynamicType($this)) == T$OAuth20NameSpace.AuthorizationServerImpl;
...
implementation OAuth20NameSpace.AuthorizationServer.TokenEndpoint$OAuth20NameSpace.AccessTokenRequest($this: Ref, req$in: Ref) returns ($result: Ref)
{
  ...
  anon49_Then:
    assume {:partition} $TypeConstructor($DynamicType($tmp31)) == T$OAuth20NameSpace.AuthorizationServerImpl.AccessTokenDictionary_def;
  ...
  anon50_Then:
    assume {:partition} !(if $TypeConstructor($DynamicType($tmp31)) == T$OAuth20NameSpace.AuthorizationServerImpl.AccessTokenDictionary_def then $tmp25 else $tmp30);
  ...
  anon51_Then:
    assume {:partition} $TypeConstructor($DynamicType($tmp46)) == T$OAuth20NameSpace.AuthorizationServerImpl.AccessTokenDictionary_def;
  ...
  anon52_Then:
    assume {:partition} (if $TypeConstructor($DynamicType($tmp46)) == T$OAuth20NameSpace.AuthorizationServerImpl.AccessTokenDictionary_def then $tmp40 else $tmp45) == null;
  ...
  anon53_Then:
    assume {:partition} $TypeConstructor($DynamicType($tmp57)) == T$OAuth20NameSpace.AuthorizationServerImpl.AccessTokenDictionary_def;
  ...
  anon56_Then:
    assume {:partition} $TypeConstructor($DynamicType($tmp76)) == T$OAuth20NameSpace.AuthorizationServerImpl.AccessTokenDictionary_def;
  ...
  anon57_Then:
    assume {:partition} !(if $TypeConstructor($DynamicType($tmp76)) == T$OAuth20NameSpace.AuthorizationServerImpl.AccessTokenDictionary_def then $tmp70 else $tmp75);
...
implementation OAuth20NameSpace.ResourceServer.RequestResource$OAuth20NameSpace.ResourceRequest($this: Ref, req$in: Ref) returns ($result: Ref)
{
  ...
  anon20_Then:
    assume {:partition} $TypeConstructor($DynamicType($this)) == T$OAuth20NameSpace.For_vProgram;
  ...
  anon21_Then:
    assume {:partition} $TypeConstructor($DynamicType($this)) == T$OAuth20NameSpace.ResourceServerImpl;
  ...
  anon23_Then:
    assume {:partition} $TypeConstructor($DynamicType($tmp26)) == T$OAuth20NameSpace.ResourceServerImpl.ResourceRecs_def;
...
implementation OAuth20NameSpace.ResourceServer.conclude$OAuth20NameSpace.ValidateTokenResponse($this: Ref, tresq$in: Ref) returns ($result: bool)
{
  ...
  anon18_Then:
    assume {:partition} $TypeConstructor($DynamicType($this)) == T$OAuth20NameSpace.ResourceServer;
...
implementation GenericAuthNameSpace.GlobalObjects_base.Assert_BadPersonCannotAccessGoodPersonsResource$GenericAuthNameSpace.RS.AuthorizationConclusion(conclusion$in: Ref)
{
  ...
  anon31_Then:
    assume {:partition} $TypeConstructor($DynamicType(F$GenericAuthNameSpace.AS.ASAuthRecs[$tmp16])) == T$OAuth20NameSpace.AuthorizationServerImpl.AccessTokenDictionary_def;
    $tmp0 := F$GenericAuthNameSpace.GlobalObjects_base.AS;
    assume $tmp0 != null;
  ...
  anon37_Then:
    assume {:partition} !(F$GenericAuthNameSpace.Permissions.permissionSet[(if $TypeConstructor($DynamicType(local_0_Ref)) == T$OAuth20NameSpace.AccessTokenEntry then $tmp25 else $tmp26)] != F$GenericAuthNameSpace.Permissions.permissionSet[$tmp28]);
    goto anon38_Then, anon38_Else;
  ...
  anon39_Then:
    assume {:partition} (if !(F$GenericAuthNameSpace.Permissions.permissionSet[(if $TypeConstructor($DynamicType(local_0_Ref)) == T$OAuth20NameSpace.AccessTokenEntry then $tmp25 else $tmp26)] != F$GenericAuthNameSpace.Permissions.permissionSet[$tmp28]) then $tmp24 else false);
...
implementation FacebookGraphApiExample.Facebook_GraphAuth.Page_Load$System.Object$System.EventArgs($this: Ref, sender$in: Ref, e$in: Ref)
{
  ...
  anon41_Then:
    assume {:partition} local_8_Ref == null;
  ...
  anon42_Then:
    assume {:partition} $TypeConstructor($DynamicType($tmp43)) == T$OAuth20NameSpace.ResourceServerImpl.EmailResource;
    $tmp31 := local_8_Ref;
    assume $tmp31 != null;
  ...
  anon43_Then:
    assume {:partition} !$tmp46;
    assume {:breadcrumb 207} true;
    assume $this != null;
    goto anon44_Then, anon44_Else;

  anon44_Then:
    assume {:partition} $TypeConstructor($DynamicType(F$FacebookGraphApiExample.Facebook_GraphAuth.notLoggedIn[$this])) == T$FacebookGraphApiExample.Facebook_GraphAuth;
  ...
  anon45_Then:
    assume {:partition} $TypeConstructor($DynamicType(F$FacebookGraphApiExample.Facebook_GraphAuth.notLoggedIn[$this])) == T$System.Web.UI.Page;
  ...
  anon46_Then:
    assume {:partition} $TypeConstructor($DynamicType(F$FacebookGraphApiExample.Facebook_GraphAuth.notLoggedIn[$this])) == T$System.Web.UI.TemplateControl;
  ...
  anon47_Then:
    assume {:partition} $TypeConstructor($DynamicType(F$FacebookGraphApiExample.Facebook_GraphAuth.LoggedIn[$this])) == T$FacebookGraphApiExample.Facebook_GraphAuth;
  ...
  anon48_Then:
    assume {:partition} $TypeConstructor($DynamicType(F$FacebookGraphApiExample.Facebook_GraphAuth.LoggedIn[$this])) == T$System.Web.UI.Page;
  ...
  anon49_Then:
    assume {:partition} $TypeConstructor($DynamicType(F$FacebookGraphApiExample.Facebook_GraphAuth.LoggedIn[$this])) == T$System.Web.UI.TemplateControl;
...
implementation OAuth20NameSpace.ResourceServerImpl.#ctor$System.String$System.String$System.String$System.String($this: Ref, rl$in: Ref, client_id$in: Ref, client_secret$in: Ref, redirect_uri$in: Ref)
{
  ...
  anon3_Then:
    assume {:partition} $TypeConstructor($DynamicType(F$OAuth20NameSpace.ResourceServerImpl.ResourceRecs[$this])) == T$OAuth20NameSpace.ResourceServerImpl.ResourceRecs_def;
    assume $this != null;
...
implementation OAuth20NameSpace.ResourceServerImpl.callValidateTokenEndpoint$OAuth20NameSpace.ValidateTokenRequest($this: Ref, treq$in: Ref) returns ($result: Ref)
{
  ...
  anon10_Then:
    assume {:partition} $TypeConstructor($DynamicType(local_0_Ref)) == T$OAuth20NameSpace.ValidateTokenResponse;
    assume {:breadcrumb 249} true;
    goto anon11_Then, anon11_Else;

  anon11_Then:
    assume {:partition} $TypeConstructor($DynamicType(treq)) == T$OAuth20NameSpace.ValidateTokenRequest;
